...
TARGET_NAME = (
    ...
    "worldcup/enterwc.big"
)

BACKUP_DIR = Path(
    r"D:\Afbeeldingen\FUT14-Revival"
    r"\backups\enterwc-force-new-user"
)
...
# 0500 AF 48       NEW_USER
# 0502 12          Not
# 0503 9D          BranchIfTrue
# 0504 28 00 00 00 branch +0x28
#
# Proof-test:
# laat BranchIfTrue bestaan, maar maak target
# de eerstvolgende instructie.
APT_OFFSET = 0x0503
